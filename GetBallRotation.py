...
def get_fine_ball_rotation(
    ...
    #full_gray_image = cv2.equalizeHist(full_gray_image)
    ...
    balls, displayimg = run_hough_with_radius(full_gray_image)
    # cv2.imshow("Ball Detection Result", displayimg)
    best_ball1, best_ball2 = balls
