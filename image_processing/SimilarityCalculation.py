...
def delta_similarity(f1, f2, down=4, blur=3, px_thresh=6):
    ...
    if down > 1:
        g1 = cv2.resize(g1, (g1.shape[1]//down, g1.shape[0]//down), interpolation=cv2.INTER_AREA)
        g2 = cv2.resize(g2, (g2.shape[1]//down, g2.shape[0]//down), interpolation=cv2.INTER_AREA)
    if blur > 0:
