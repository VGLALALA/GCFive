...
class tSdkFrameEvent(MvStructure):
    _fields_ = [
        ...
        (
            "TimeStampL",
            c_uint,
        ),  # ///< \~chinese 时间戳低32位 \~english Lower 32 bits of timestamp
        (
            "TimeStampH",
            c_uint,
        ),  # ///< \~chinese 时间戳高32位 \~english High 32 bits of timestamp
    ]
...
# 帧事件回调
CAMERA_FRAME_EVENT_CALLBACK = CALLBACK_FUNC_TYPE(
    None, c_int, POINTER(tSdkFrameEvent), c_void_p
)
